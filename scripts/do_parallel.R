...
auc_list_mclapply <- parallel::mclapply(split_lai, apply_auc, mc.cores=32)
...
quant_list_mclapply <- parallel::mclapply(split_auc, apply_quant, mc.cores=32)
